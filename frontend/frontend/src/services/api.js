...
export const loginSuperAdmin = (datos) => api.post('/auth/login', datos, { skipAuth: true })

export const obtenerCampanas = (params, config = {}) => api.get('/campaigns', { params, ...config })
export const obtenerCampanasPublicas = (params) => obtenerCampanas(params, { skipAuth: true })
...
export const eliminarCampana = (id) => api.delete(`/campaigns/${id}`)
...
export const obtenerProgresoCampanaPublico = (id) => api.get(`/campaigns/${id}/progress`, {
  skipAuth: true,
})
...
export const obtenerUrlComprobanteDonacion = (id) => `${API_URL}/api/donations/receipt/${id}`

export const obtenerDonacionesVirtuales = (params, config = {}) => api.get('/campaigns/virtual-income', { params, ...config })
export const obtenerDonacionesVirtualesPublicas = (params) => obtenerDonacionesVirtuales(params, { skipAuth: true })
...
export const loginUsuarioCompania = (datos) => api.post('/companies/users/login', datos, { skipAuth: true })
