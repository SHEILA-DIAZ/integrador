...
import { obtenerDonacionesVirtuales, obtenerMensajeApi } from '../../services/api'
  ...
  useEffect(() => {
    ...
    const cargarDonaciones = async () => {
      ...
      try {
        ...
        if (!cancelado) {
          setDonaciones([])
          setMensaje(obtenerMensajeApi(err, 'No se pudieron cargar las donaciones virtuales. Intenta nuevamente.'))
        }
      } finally {
    ...
    <AdminLayout active="donations">
      <div className="ai-heading">
        <div>
          <div className="ai-title-row">
            ...
            <span className="ai-readonly">Solo Lectura</span>
          </div>
      ...
      <section className="ai-summary" aria-label="Resumen de donaciones virtuales">
        ...
        <article className="ai-card">
          ...
          <span className="ai-card-icon blue">♙</span>
        </article>
        <article className="ai-card">
          <div>
            <span>Promedio</span>
          ...
          <span className="ai-card-icon purple">↗</span>
        </article>
        <article className="ai-card">
          <div>
          ...
          <span className="ai-card-icon orange">▭</span>
        </article>
      </section>
